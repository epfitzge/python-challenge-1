...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection = input("Please select the item # you would like to order: ")
            ...
            if quantity.isdigit():
                ...
                default = int(1)
                print(f"Your quantity has defaulted to {default}")
    ...
    while True:
        ...
        match keep_ordering.lower():
            ...
            case _:
                print("Please try again because you did not enter a valid input")
